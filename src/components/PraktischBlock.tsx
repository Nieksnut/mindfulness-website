    ...
    >
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6">
          ...
          <li>
            Praktische oefeningen zoals zit- en lichaamsmeditatie, beweging
            (mindful yoga) en korte reflectiemomenten
          </li>
          <li>
            Thema’s als omgaan met stress, automatische patronen herkennen,
            acceptatie en zelfzorg
          </li>
          <li>Dagelijkse thuisoefeningen ter verdieping</li>
          <li>
            Heldere uitleg, ruimte voor uitwisseling en begeleiding door een
